...
public class LeadEntityViewsTest extends BrowserSetup {
	...
	public void test01_SeTestTCLeadListView() throws Exception {
		...
		if (commNav.isPageDisplayed(expEntityPgTitle)) {
			...
			//Step: check the Leads Search widget elements
			commNav.checkIfWebElementPresent("Leads List View, Search - input text box", LeadListView.leadsSearchTxtBox);
			LeadListView.leadsSearchTxtBox.click();
			commNav.checkIfWebElementPresent("Leads List View, Search - input clear button", LeadListView.leadsSearchClearBtn);
			commNav.checkIfWebElementPresent("Leads List View, Search - Lookup button", LeadListView.leadsSearchLookupBtn);
			...
			commNav.checkIfWebElementPresent("Leads List View, item record line 2", LeadListView.topLeadsListItemLine2);
			commNav.checkIfWebElementPresent("Leads List View, item record line 3", LeadListView.topLeadsListItemLine3);
			commNav.checkIfWebElementPresent("Leads List View, item record line 4", LeadListView.topLeadsListItemLine4);
			commNav.checkIfWebElementPresent("Leads List View, item record line 5", LeadListView.topLeadsListItemLine5);
