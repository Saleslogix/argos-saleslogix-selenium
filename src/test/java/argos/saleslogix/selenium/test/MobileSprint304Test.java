...
public class MobileSprint304Test extends BaseTest {
    ...
    public void test05_MobileDefect_MBL10137() throws Exception {
        ...
        try {
            if (!driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*" + filter2Check + "[\\s\\S]*$"))
                System.out.println(resultsMsg + " - Passed");
        } catch (Error e) {
            System.out.println(methodID + "(): " + e.toString());
            System.out.println(resultsMsg + " - Failed");
    ...
    public void test06_MobileDefect_MBL10139() throws Exception {
        ...
        try {
            if (!driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*" + htmlCode + "[\\s\\S]*$"))
                System.out.println(resultsMsg + " - Passed");
        } catch (Error e) {
            System.out.println(methodID + "(): " + e.toString());
            System.out.println(resultsMsg + " - Failed");
