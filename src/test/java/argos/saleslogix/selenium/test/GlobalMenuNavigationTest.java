...
public class GlobalMenuNavigationTest extends BaseTest {
    ...
    public void test03_SeTestTCGlobalMenuDoSpeedSearch() throws Exception {
        ...
        for (int second = 0; ; second++) {
            if (second >= 60) Assert.fail("timeout");
            try {
                if (isElementPresent(By.xpath(".//*[@id='Mobile_SalesLogix_SpeedSearchWidget_0']/div/div[1]/input")))
                    break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
    ...
    public void test04_SeTestTCGlobalMenuEditAccount() throws Exception {
        ...
        for (int second = 0; ; second++) {
            if (second >= 60) Assert.fail("timeout");
            try {
                if (isElementPresent(By.cssSelector("#Sage_Platform_Mobile_Fields_TextField_14 > input[name=\"AccountName\"]")))
                    break;
            } catch (Exception e) {
            }
            Thread.sleep(1000);
